...
static constexpr uint16_t DMP_FIRMWARE_BANK_SIZE = 256;
static constexpr uint8_t DMP_UPLOAD_CHUNK_SIZE = 16;

static constexpr uint8_t DMP_FIRMWARE[DMP_FIRMWARE_SIZE] = {
	/* bank #0 */
