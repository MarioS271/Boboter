...
namespace Task::Subtask {
    ...
    uint32_t display_subtask() {
        ...
        snprintf(buffer, sizeof(buffer), "L%2ld R%2ld  D%2.1f",
            ...
            /*robot.ultrasonic.get_distance()*/ -1.0f);
        ...
        snprintf(buffer, sizeof(buffer), "Alloc: %d KiB", info.total_allocated_bytes / 1024);
        ...
        robot.display.write_buffer_to_display();
